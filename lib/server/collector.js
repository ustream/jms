...
function loadModules (modulereq, done) {
	...
	storage.hmget('codebase', m, function (err, result) {
...
function loadModuleDeps (modulereq, modulesToLoad, alreadyLoaded, done) {
	...
	storage.hmget('codebase', modulesToLoad, function (err, result) {
		...
		alreadyLoaded = alreadyLoaded.concat(moduleList);
