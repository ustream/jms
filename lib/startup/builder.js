...
var PluginManager       = require(paths.libdir + '/pluginmanager.js');
...
var ModuleCompressor    = require(paths.libdir + '/codebase/modulecompressor.js');
...
function build (is_deploy, build, isRunning, next) {
	...
	var plugins = PluginManager.Deploy;
	plugins.setEncoding('utf8');

	var compress = new ModuleCompressor({ objectMode: true });
	compress.setEncoding('utf8');
